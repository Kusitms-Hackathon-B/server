...
import com.example.kusitmshackthon.exception.badrequest.FileInvalidRequestException;
import com.example.kusitmshackthon.exception.badrequest.FileUploadException;
...
public class S3Provider {
    // S3Config에 등록된 S3 접근 권한 객체입니다.ㅂ
    ...
    private void validateMultipartFile(MultipartFile multipartFile) {
        if (multipartFile == null || multipartFile.isEmpty()) {
            throw new FileInvalidRequestException();
        }
    }
