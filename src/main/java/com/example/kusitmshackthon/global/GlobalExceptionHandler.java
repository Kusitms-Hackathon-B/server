package com.example.kusitmshackthon.global;

import com.example.kusitmshackthon.exception.CustomException;
import com.example.kusitmshackthon.exception.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNumberOneException(CustomException e) {
    ...
    public ResponseEntity<ErrorResponse> unhandledException(Exception e, HttpServletRequest request) {
        ...
        return ResponseEntity.internalServerError()
                .body(new ErrorResponse(9999, "예기치 않은 오류가 발생했습니다. 서버 관리 팀에 문의바랍니다."));
    }
}